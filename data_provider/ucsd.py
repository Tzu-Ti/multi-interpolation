...
class InputHandle:
    ...
    def load(self):
        ...
        #print(self.data['clips'][0,0:20,1])
    ...
    def input_batch(self):
        ...
        #print('dims[0]',self.data['dims'][0],'zeros',(self.current_batch_size, self.current_input_length) +
        #    tuple(self.data['dims'][0]))
        #print('dims', self.data['dims'])
