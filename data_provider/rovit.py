...
class InputHandle:
    ...
    def input_batch(self, isRev):
        ...
        for i in range(self.current_batch_size):
            ...
            if isRev == False:
                ...
                begin = self.data['clips'][0, batch_ind, 0]-1
                end = self.data['clips'][0, batch_ind, 0] + \
                        self.data['clips'][0, batch_ind, 1]-1
    ...
    def output_batch(self, isRev):
        ...
        for i in range(self.current_batch_size):
            ...
            if isRev == False:
                ...
                begin = self.data['clips'][1, batch_ind, 0]-1
                end = self.data['clips'][1, batch_ind, 0] + \
                        self.data['clips'][1, batch_ind, 1]-1
            print('output:   begin:', begin,'end:', end)
            if self.is_output_sequence:
    ...
    def get_batch(self, isRev):
        input_seq = self.input_batch(isRev)
        output_seq = self.output_batch(isRev)
